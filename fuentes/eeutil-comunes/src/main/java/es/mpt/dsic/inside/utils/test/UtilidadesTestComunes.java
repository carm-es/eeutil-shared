...
public class UtilidadesTestComunes implements IPruebaTraza {
  protected static final Log logger = LogFactory.getLog(UtilidadesTestComunes.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-comunes es correcta");
