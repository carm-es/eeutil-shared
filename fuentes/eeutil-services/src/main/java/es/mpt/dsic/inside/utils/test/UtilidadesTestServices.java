...
public class UtilidadesTestServices implements IPruebaTraza {
  protected static final Log logger = LogFactory.getLog(UtilidadesTestServices.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-service es correcta");
