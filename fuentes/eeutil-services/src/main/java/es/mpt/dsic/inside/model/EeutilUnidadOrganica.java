...
public class EeutilUnidadOrganica extends Entidad {
  ...
  public EeutilUnidadOrganica() {}

  public EeutilUnidadOrganica(String codigoUnidadOrganica, String nombreUnidadOrganica,
  ...
  public EeutilUnidadOrganica(String codigoUnidadOrganica, String nombreUnidadOrganica,
      ...
      Date fechaExtincion, Date fechaUltimaActualizacion, String horarioAtencion, String version,
      String vUnidadRaiz, String vUnidadSuperiorOResponsable, String poder) {
    this.codigoUnidadOrganica = codigoUnidadOrganica;
    this.nombreUnidadOrganica = nombreUnidadOrganica;
    this.nivelAdministracion = nivelAdministracion;
    this.entidadDerechoPublico = entidadDerechoPublico;
  ...
  // devuelve el id pero si el salto de la secuencia.
  public Integer dameIde() {
    return this.id;
  }
  ...
  public String toString() {
    ...
    tmpBuff.append(dateToStringISO8601(fechaAlta));
    tmpBuff.append(coma);
    tmpBuff.append("fechaBaja=");
    tmpBuff.append(dateToStringISO8601(fechaBaja));
    tmpBuff.append(coma);
    tmpBuff.append("fechaAnulacion=");
    tmpBuff.append(dateToStringISO8601(fechaAnulacion));
    tmpBuff.append(coma);
    tmpBuff.append("fechaExtincion=");
    tmpBuff.append(dateToStringISO8601(fechaExtincion));
    tmpBuff.append(coma);
    // version 3 y 4
    tmpBuff.append("fechaUltimaActualizacion=");
    tmpBuff.append(dateToStringISO8601(fechaUltimaActualizacion));
    // fin version 3 y 4
    tmpBuff.append("]");
   ...
   * @return
   */
  private static String dateToStringISO8601(Date date) {
    String retorno = "";
    if (date != null) {
