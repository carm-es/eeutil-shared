...
public class UnidadOrganicaConverter {
  ...
  public static UnidadOrganica toEntity(Organismo datos, Date syncDate) {
    ...
    retorno.setHorarioAtencion(datos.getDatosIdentificativos().getHorarioAtencion());
    retorno.setPoder(datos.getDatosIdentificativos().getPoder());

    // datos dependencia
    retorno.setVersion(datos.getDatosIdentificativos().getVersion());
    retorno.setvUnidadRaiz(datos.getDatosIdentificativos().getVersionUnidadRaiz());
    retorno.setvUnidadSuperiorOResponsable(
        datos.getDatosIdentificativos().getvUOSuperiorOResponsable());
    ...
    retorno.setFechaUltimaActualizacion(datos.getDatosVigencia().getFechaUltimaActualizacion());
