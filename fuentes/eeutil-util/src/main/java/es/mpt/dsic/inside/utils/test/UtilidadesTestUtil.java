...
public class UtilidadesTestUtil implements IPruebaTraza {

  /**
   * test para comprobar que el log utiliza la dependencia SLF4J
   */

  protected static final Log logger = LogFactory.getLog(UtilidadesTestUtil.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-util es correcta");
